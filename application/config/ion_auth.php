...
$config['admin_email']                = "system@nbr-nep.com"; // Admin Email, admin@example.com
$config['default_group']              = 'officer';            // Default group, use name
//$config['admin_group']              = 'admin';              // Default administrators group, use name
$config['admin_group']                = array('IT Officer','member'); // Default administrators group, use name
