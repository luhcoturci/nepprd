...
<!-- Let's load js dynamically: custom helper() queuescript_helper.php -->
...
/*
  $('#autofill').on("change",function() {
	  var highlevel = 'Dear Sir/Madam, <br /><br />Your Enquiry is valuable to us. However, in this case it falls beyond the scope of the'
		  + 'Customs National Enquiry Point. <br /> Please contact: **** <br /><br />'
		  + 'For further assistance in this matter. <br /><br />With Best Regards,';
	  $('#autotextarea').code(highlevel);
  });
*/
  $('#autofill').on("change",function() {
	  // var highlevel = $('#autotext-1').text();
	  //alert($('#autotext-1').text());
...
//Dual List Plugin Init
 ...
 /* $("#adduser").submit(function() {
  ...
  $('.nexttext').click(function() {
      ...
      //alert($('input[name=src-eval]:checked','#handling-form').val());
