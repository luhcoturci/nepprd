  <footer>        
    <div class="row">      
      ...
      <div class="col-lg-12 text-center">
        <a href="#unansweredModal" data-toggle="modal" class="btn btn-primary gradient">
          <small><i class="fa fa-life-ring"></i> <?php echo $this->lang->line('home_help');?></small>
        </a>            
      </div>
      <?php } ?>
    </div>
...
<script>
  ...
  (function ($) {
    ...
    $(document).ready(function() {
  	  $('.summernote').summernote();//For some reason sumernote libray is commented out -->Nel want to know 
  	});
</script>
...
$('#send-enquiry-modal').click(function() {
